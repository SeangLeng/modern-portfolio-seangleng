      ...
      <div className='lg:flex md:flex justify-between items-center py-36 px-[10%]'>
        <div className='lg:w-1/2 md:w-2/3' data-aos="fade-right">
          <div className='grid gap-10px'>
            <p className='text-white lg:text-7xl md:text-5xl text-4xl uppercase font-bold'>seng</p>
            <p className='text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600 lg:text-8xl md:text-5xl text-5xl uppercase font-bold'>seang leng</p>
          </div>
