...
export default function About() {
    return (
        <div className="min-h-screen lg:flex md:flex justify-around flex-row-reverse items-center">
            <div className='lg:w-1/2 md:w-1/2' data-aos="fade-right">
                ...
                <div className='mt-10'>
                    <Link href='/service/frontend' className='bg-gradient-to-r hover:bg-gradient-to-l transition-all from-blue-400 to-blue-600 text-white text-lg px-5 py-2 font-medium rounded-lg'>More</Link>
                </div>
            </div>
